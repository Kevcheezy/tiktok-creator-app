...
export async function PATCH(
  ...
  try {
    ...
    const ALWAYS_ALLOWED = ['product_placement', 'product_image_url', 'product_data', 'negative_prompt_override', 'fast_mode', 'video_retries', 'scene_override', 'scene_preset_id', 'interaction_override', 'interaction_preset_id', 'style_preset_id', 'syllable_targets', 'keyframe_chaining'] as const;
